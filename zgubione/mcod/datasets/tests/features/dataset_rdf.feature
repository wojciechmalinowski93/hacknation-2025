Feature: Dataset RDF API
  Scenario Outline: Test that dataset RDF endpoint returns data in format specified in url.
    ...
    | /catalog/dataset/999.nt11             | content-type     | application/n-triples |
    | /catalog/dataset/999.nquads           | content-type     | application/n-quads   |
    | /catalog/dataset/999.ttl              | content-type     | text/turtle           |
    | /catalog/dataset/999.turtle           | content-type     | text/turtle           |
    | /catalog/dataset/999.rdf              | content-type     | application/rdf+xml   |
    | /catalog/dataset/999.trig             | content-type     | application/trig      |
    | /catalog/dataset/999.trix             | content-type     | application/trix      |
    | /catalog/dataset/999.xml              | content-type     | application/rdf+xml   |
    ...
    | /catalog/dataset/999,test-rdf.nt11    | content-type     | application/n-triples |
    | /catalog/dataset/999,test-rdf.nquads  | content-type     | application/n-quads   |
    | /catalog/dataset/999,test-rdf.ttl     | content-type     | text/turtle           |
    | /catalog/dataset/999,test-rdf.turtle  | content-type     | text/turtle           |
    | /catalog/dataset/999,test-rdf.rdf     | content-type     | application/rdf+xml   |
    | /catalog/dataset/999,test-rdf.trig    | content-type     | application/trig      |
    | /catalog/dataset/999,test-rdf.trix    | content-type     | application/trix      |
    | /catalog/dataset/999,test-rdf.xml     | content-type     | application/rdf+xml   |
